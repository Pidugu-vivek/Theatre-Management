...
function submitForms() {
    ...
    var form4Data = new FormData(document.getElementById("form4"));
 ...
 function checklocationchanged(){
  ...
  async function getAllsuggestion() {
      ...
      let res = await fetch("http://localhost:3000/movies/getsuggestion", {
          ...
          method: "post",
          body:JSON.stringify({city:document.querySelector('input[name="location"]').value,datevalue:document.querySelector('input[name="date"]').value}),
          headers: {
